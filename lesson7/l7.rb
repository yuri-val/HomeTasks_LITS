...
class Replacer
   ...
   def replace params
      ...
      name_tag  = "<h1 class=\"well\" id=\"name\">#{params.name}</h1>"
      email_tag = "<span class=\"badge\" id=\"email\">#{params.email}</span>"
      phone_tag = "<span class=\"badge\" id=\"phone\">#{params.phone}</span>"

      @data_from_file.sub! name_patern,  name_tag
      @data_from_file.sub! email_patern, email_tag
      @data_from_file.sub! phone_patern, phone_tag
